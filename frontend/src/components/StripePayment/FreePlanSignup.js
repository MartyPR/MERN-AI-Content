...
import { handleFreeSubscriptionAPI } from "../../services/stripepayment/stripePayment";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-900 flex justify-center items-center p-6">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full">
        ...
        {mutation?.isSuccess && <StatusMessage type="success" message="Free plan subscription successfull"/>}
        <p className="text-center text-gray-600 mb-4">
          Enjoy our free plan with no costs involved. Get started now andF
