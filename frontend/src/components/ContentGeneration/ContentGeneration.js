...
import { generateContentAPI } from "../../services/chatGPT/chatGPT";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-900 flex justify-center items-center p-6">
      <div className="bg-white rounded-xl shadow-xl overflow-hidden max-w-2xl w-full p-6">
        ...
        {mutation?.isSuccess && <StatusMessage type="success" message="Contetn generation is sucessfull" />}
        {mutation?.isError && (
          <StatusMessage
            type="error"
        ...
        <div className="flex mt-3">
          <div className="mr-2">
            <span className="text-sm font-semibold bg-green-200 px-4 py2 rounded-full">
